...
export const INPUT_CLASS =
  "px-2 py-1 rounded border border-vscode-input-border bg-vscode-input-bg text-vscode-input-fg focus:outline-none focus:border-vscode-focus-border";

/** Standard text input styling with error border. */
export function inputClass(error?: boolean): string {
  return `px-2 py-1 rounded border bg-vscode-input-bg text-vscode-input-fg focus:outline-none focus:border-vscode-focus-border ${
...
export const SUB_LABEL_CLASS = "block text-secondary text-vscode-description-fg mb-0.5";

/** Inline validation error message. */
export const ERROR_CLASS = "text-tertiary text-vscode-error-fg mt-0.5";
...
export const DELETE_BUTTON_CLASS =
  "text-tertiary text-vscode-error-fg hover:opacity-80 px-0.5 shrink-0";

/** CSS variable name preview text. */
export const CSS_VAR_PREVIEW_CLASS =
  "text-quaternary text-vscode-description-fg font-mono mt-1";
...
export const PRIMARY_BUTTON_CLASS =
  "px-2 py-0.5 text-secondary rounded bg-vscode-button-bg text-vscode-button-fg hover:bg-vscode-button-hover";
